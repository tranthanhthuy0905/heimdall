...
trait SessionsConversions extends LazyLogging with Results {
  ...
  protected def rescue[B](description: String)(future: com.twitter.util.Future[B])(
  ...
  protected def rescueSessionsCalls[T](future: com.twitter.util.Future[T], func: String)(
    implicit ex: ExecutionContext): Future[Either[SessionsServiceErrorCode, T]] = {
